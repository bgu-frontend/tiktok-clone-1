...
const Discover = () => {
  ...
  const activeTopicStyle =
    "xl:border-2 hover:bg-primary xl:border-[var(--primary-color)] px-3 py-2 rounded xl:rounded-full flex items-center gap-2 justify-center cursor-pointer text-[var(--primary-color)]";
  const topicStyle =
